<!--
Reglas de AWS instaladas el 7 de septiembre de 2026 por el Agent Toolkit for AWS,
siguiendo https://github.com/aws/agent-toolkit-for-aws/blob/main/setup-instructions/setup.md

Origen del texto de abajo: rules/aws-starter-rules.md de ese mismo repositorio.
Para dejar de cargarlas, borra este archivo. Perfil del CLI: nexcode (us-east-1).
-->

# Nexcode · instrucciones del proyecto

## Restricción propia del proyecto

**Todo servicio y toda prueba deben caber en el nivel gratuito.** Es criterio
eliminatorio, no desempate: si una opción cobra, no es una opción. Antes de crear
cualquier recurso en AWS va la alarma de presupuesto. Ver `CONTEXTO-DEL-PROYECTO.md`,
sección 9.
...
- help_level: **HIGH**, elegido por el usuario el 7 de septiembre de 2026. Ya esta fijado, no hay que preguntarlo otra vez. (Pregunta original: "How much guidance would you like from me? Low (I only flag security risks), medium (I ask a couple of clarifying questions if something seems off), or high (I explain what I'm doing, suggest alternatives, and flag best practices).")
